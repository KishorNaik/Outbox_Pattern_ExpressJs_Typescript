import { IServiceHandler, Result, ResultFactory, sealed, Service, StatusCodes, StatusEnum, tryCatchResultAsync } from "@kishornaik/utils";
...
export interface ICreateMapUserEntityService extends IServiceHandlerAsync<CreateUsersRequestDto,UserEntity>{}
