...
import { FeaturePostRequestDto } from '@/modules/restApiDemo/apps/features/v1/featurePost/contracts';

process.env.NODE_ENV = 'development';
ValidateEnv();

const appInstance = new App();
appInstance.initializeRestApiRoutes([...restApiModulesFederation]).initializeErrorHandling();
